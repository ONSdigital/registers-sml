...
##        And a Strata of selection type Prn-Sampling from Stratification Properties file:
##            | inqcode | cell_no | cell_desc | seltype | lower_class | upper_class | lower_size | upper_size | prn_start   | no_reqd |
##            | 687     | 5819    | Sample    | P       | 45111       | 45190       | 50         | 9          | -0.12917704 | 100000  |
##        When a <language> Sample is created from a Stratified Frame
##        Then a report is returned with the invalid Prn Start Point strata logged
##
##        @JVM
##        Examples:
##        | language |
...
##        And a Strata of selection type Prn-Sampling from Stratification Properties file:
##            | inqcode | cell_no | cell_desc | seltype | lower_class | upper_class | lower_size | upper_size | prn_start   | no_reqd |
##            | 687     | 5819    | Sample    | P       | 45111       | 45190       | 50         | 9          | 0.129177704 | -10000  |
##        When a <language> Sample is created from a Stratified Frame
##        Then a report is returned with the invalid Sample Size strata logged
##
##        @JVM
##        Examples:
##        | language |
