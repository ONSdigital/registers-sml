...
#        Then a Sample DataFrame is returned, with the invalid Prn Start Point strata logged
#
#        @JVM
#        Examples:
...
#            | <input_path>      | <strat_properties_path> | <output_path>     |
#        When a <language> Sample is created from the pre-filtered Frame
#        Then a Sample DataFrame is returned, with the invalid Sample Size strata logged
#
#        @JVM
#        Examples:
#        | language | input_path                                 | strat_properties_path                                 | output_path                                         |
