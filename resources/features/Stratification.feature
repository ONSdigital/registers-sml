...
Feature: Create a Stratified Frame
    ...
    @HappyPath
    Scenario Outline: Apply sic07 and payeEmployee range filters on a Frame that contains null values in the paye_empees
        """
        ...
        Given a Frame where some units have PayeEmployee field as null:
            ...
            | 1100000006 | 9906000205 | HIBAER                        |              | 1 GLEN ROAD              | HINDHEAD       | SURREY      |                         |          | GU26 6QE | 1           | 45112 | null        | 1         | 297          | 297          | 0            | 0             | 0            | 0.588701588 |
            ...
            | 1100000008 | 9906000325 | TLUBARE                       |              | 1 GORSE ROAD             | REYDON         | SOUTHWOLD   |                         |          | IP18 6NQ | 1           | 45138 | null        | 3         | 197          | 197          | 0            | 0             | 0            | 0.446872271 |
            | 1100000009 | 9906000355 | BUCARR                        |              | 1 GRANVILLE AVENUE       | LONG EATON     | NOTTINGHAM  |                         |          | NG10 4HA | 1           | 45240 | 41          | 1         | 18           | 18           | 0            | 0             | 0            | 0.847311602 |
            | 1100000010 | 9906000405 | DCAJ&WALTON                   |              | 1 GRANVILLE AVENUE       | LONG EATON     | NOTTINGHAM  |                         |          | NG10 4HA | 1           | 45155 | null        | 2         | 72           | 72           | 0            | 0             | 0            | 0.548604086 |
        ...
        When a <language> Stratified Frame is created from a Frame
        Then a Stratified Frame is returned with the strata assigned the Strata number from the Stratification Strata and unit with null values in payeEmployee field are labelled as -2:
            | ern        | entref     | name                          | tradingstyle | address1                 | address2       | address3    | address4                | address5 | postcode | legalstatus | sic07 | paye_empees | paye_jobs | ent_turnover | std_turnover | grp_turnover | cntd_turnover | app_turnover | prn         | cell_no |
